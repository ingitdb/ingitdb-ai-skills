...
**How might we ensure that after installing the inGitDB plugin, the very next `ingitdb-*` skill invocation succeeds — without making the plugin itself own multi-platform binary distribution?**
